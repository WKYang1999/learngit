                    ...
                    <div class="box box-success">
                        ...
                        <div class="box-body">
                                    ...
                                    <form id="searchForm" action="" onsubmit="return false;" class="form-inline">
                                        <div class="form-group">
                                            <select class="form-control" name="name">
                                                ...
                                                <option value="reportCommName">名称</option>
                                            </select>
                                        </div>
                                        <div class="form-group">
                            ...
                            <div id="toolbar">
                                ...
                                <button type="button" data-ope="update" class="btn bg-blue btn-flat">删除评论</button>
                            </div>
                            <table id="reportComm_table"></table>
                        </div>
                    </div>
                </div>
            </div>
...
<script type="text/javascript">
    $(function(){
        var $reportCommTable;
        var queryURL="${pageContext.request.contextPath}/reportComms/xx";
        $reportCommTable = $('#reportComm_table').bootstrapTable({
            url: queryURL,
            method: 'GET',
        ...
        $("#searchForm").on("submit",function(){
            $reportCommTable.bootstrapTable('refresh');
            return false;
        });
        ...
        $("#toolbar").on("click","button",function(){
            ...
            if(ope=="delete"){
                //获取选中的
                var idArray = $reportCommTable.bootstrapTable('getAllSelections');
                if(idArray.length==0){
                    alert("至少选择一个");
                    return;
                }
                ...
                $.ajax({
                    type:"post",
                    url:"${pageContext.request.contextPath}/reportComms/"+idArray.join(),
                    data:"_method=delete",
                ...
                $.ajax({
                    type:"post",
                    url:"${pageContext.request.contextPath}/reportComms/delete/"+idArray.join(),
                    data:"_method=delete",
                    success:function(respData){
                        if(respData.code==200){
                            $reportCommTable.bootstrapTable('refresh');
