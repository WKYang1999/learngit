                ...
                <div class="col-xs-12">
                    <div class="box box-success">
                        ...
                        <div class="box-body">
                            ...
                            <div id="toolbar">
                                <a href="${pageContext.request.contextPath}/videoNums/add" class="btn bg-maroon btn-flat">添加</a>
...
<script type="text/javascript">
    $(function(){
        var $videoNumTable;
        var queryURL="${pageContext.request.contextPath}/videoNums/xx";
        ...
        $("#toolbar").on("click","button",function(){
            ...
            if(ope=="delete"){
                ...
                window.location.href="${pageContext.request.contextPath}/videoNums/"+idArray[0].id+"/edit";
            }
        });
    });
</script>
