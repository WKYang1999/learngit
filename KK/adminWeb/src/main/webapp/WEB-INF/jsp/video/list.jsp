                ...
                <div class="col-xs-12">
                    <div class="box box-success">
                        ...
                        <div class="box-body">
                                    ...
                                    <form id="searchForm" action="" onsubmit="return false;" class="form-inline">
                                        <div class="form-group">
                                            <select class="form-control" name="name">
                                                ...
                                                <option value="videoName">名字</option>
                                            </select>
                                        </div>
                                        <div class="form-group">
                            ...
                            <div id="toolbar">
                                <a href="${pageContext.request.contextPath}/videos/add" class="btn bg-aqua btn-flat">添加</a>
                                <button type="button" data-ope="delete" class="btn bg-maroon btn-flat">下架</button>
                                <button type="button" data-ope="select" class="btn bg-olive btn-flat">上架</button>
...
<script type="text/javascript">
    $(function(){
        var $videoTable;
        var queryURL="${pageContext.request.contextPath}/videos/xx";
        $videoTable = $('#video_table').bootstrapTable({
            url: queryURL,
            method: 'GET',
            ...
            queryParams : function (params) {
                var statefind = $("#searchForm select[name='state']").val();
                params.pageSize=params.limit;
                delete params.limit;
                params.pageNum=params.offset/params.pageSize+1;
                params.state = statefind;
        ...
        $("#toolbar").on("click","button",function(){
            ...
            if(ope=="delete"){
                //获取选中的
                var idArray = $videoTable.bootstrapTable('getAllSelections');
                idArray = idArray.map(function(item,index){
                    return item.id;
                });
                $.ajax({
                    type:"post",
                    url:"${pageContext.request.contextPath}/videos/"+idArray.join(),
                    data:"_method=delete",
                ...
                $.ajax({
                    type:"post",
                    url:"${pageContext.request.contextPath}/videos/yy/"+idArray.join(),
                    data:"_method=delete",
                    success:function(respData){
                        if(respData.code==200){
                            alert(respData.msg);
                ...
                window.location.href="${pageContext.request.contextPath}/videos/"+idArray[0].id+"/edit";
            }
        });
    });
</script>
