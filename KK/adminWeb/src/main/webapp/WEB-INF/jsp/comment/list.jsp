...
<script type="text/javascript">
    $(function(){
        ...
        var queryURL="${pageContext.request.contextPath}/comments/"+userId+"/xx";
        $commentTable = $('#comment_table').bootstrapTable({
            url: queryURL,
            method: 'GET',
        ...
        $('#comment_table').on("click","a[name='child']",function(){
        ...
        $("#toolbar").on("click","button",function(){
            ...
            if(ope=="delete"){
                //获取选中的
                var idArray = $commentTable.bootstrapTable('getAllSelections');
                idArray = idArray.map(function(item,index){
                    return item.id;
                });
                // delete  /comments/1,2,3,4
                $.ajax({
                    type:"post",
                    url:"${pageContext.request.contextPath}/comments/"+idArray.join(),
                    data:"_method=delete",
                ...
                window.location.href="${pageContext.request.contextPath}/comments/"+idArray[0].id+"/edit";
            }
        });
    });
</script>
