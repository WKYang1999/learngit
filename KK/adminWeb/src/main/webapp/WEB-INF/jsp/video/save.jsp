            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-info">
                        <!-- form start -->
                        <form id="form_video" class="form-horizontal" action="${pageContext.request.contextPath}/videos/${videoVO.id}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="box-footer">
                                ...
                                <a href="${pageContext.request.contextPath}/videos" class="btn btn-primary btn-flat">返回</a>
