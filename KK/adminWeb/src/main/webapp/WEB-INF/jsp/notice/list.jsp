                ...
                <div class="col-xs-12">
                    <div class="box box-success">
                        ...
                        <div class="box-body">
                            ...
                            <div id="toolbar">
                                <a href="${pageContext.request.contextPath}/notices/add" class="btn bg-maroon btn-flat">添加</a>
...
<script type="text/javascript">
    $(function(){
        var $noticeTable;
        var queryURL="${pageContext.request.contextPath}/notices/xx";
        $noticeTable = $('#notice_table').bootstrapTable({
            url: queryURL,
            method: 'GET',
        ...
        $('#notice_table').on("click","a[name='child']",function(){
        ...
        $("#toolbar").on("click","button",function(){
            ...
            if(ope=="delete"){
                //获取选中的
                var idArray = $noticeTable.bootstrapTable('getAllSelections');
                idArray = idArray.map(function(item,index){
                    return item.id;
                });
                // delete  /notices/1,2,3,4
                $.ajax({
                    type:"post",
                    url:"${pageContext.request.contextPath}/notices/"+idArray.join(),
                    data:"_method=delete",
                ...
                window.location.href="${pageContext.request.contextPath}/notices/"+idArray[0].id+"/edit";
            }
        });
    });
</script>
