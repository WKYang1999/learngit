                ...
                <div class="col-xs-12">
                    <div class="box box-success">
                        ...
                        <div class="box-body">
                            ...
                            <div id="toolbar">
                                <a href="${pageContext.request.contextPath}/users/add" class="btn bg-aqua btn-flat">添加</a>
                                <button type="button" data-ope="delete" class="btn bg-maroon btn-flat">注销</button>
                                <button type="button" data-ope="select" class="btn bg-olive btn-flat">启用</button>
...
<script type="text/javascript">
    $(function(){
        var $userTable;
        var queryURL="${pageContext.request.contextPath}/users/xx";
        ...
        $("#toolbar").on("click","button",function(){
            ...
            if(ope=="delete"){
                //获取选中的
                var idArray = $userTable.bootstrapTable('getAllSelections');
                idArray = idArray.map(function(item,index){
                    return item.id;
                });
                $.ajax({
                    type:"post",
                    url:"${pageContext.request.contextPath}/users/"+idArray.join(),
                    data:"_method=delete",
                ...
                $.ajax({
                    type:"post",
                    url:"${pageContext.request.contextPath}/users/yy/"+idArray.join(),
                    data:"_method=delete",
                    success:function(respData){
                        if(respData.code==200){
                            alert(respData.msg);
                ...
                window.location.href="${pageContext.request.contextPath}/users/"+idArray[0].id+"/edit";
            }
        });
    });
</script>
