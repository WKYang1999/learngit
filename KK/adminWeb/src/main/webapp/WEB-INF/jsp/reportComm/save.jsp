            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-info">
                        <!-- form start -->
                        <form class="form-horizontal" action="${pageContext.request.contextPath}/videos/${videoVO.id}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="box-body">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" id="primary" name="primary"  class="form-control" placeholder="一级分类" value="${videoVO.primary}" data-bv-notempty="true"/>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" id="state" name="state"  class="form-control" placeholder="状态" value="${videoVO.state}" data-bv-notempty="true"/>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
