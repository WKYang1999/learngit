...
<script type="text/javascript">
    $(function(){
        ...
        var queryURL="${pageContext.request.contextPath}/recomms/"+userId+"/xx";
        $recommTable = $('#recomm_table').bootstrapTable({
            url: queryURL,
            method: 'GET',
        ...
        $("#searchForm").on("submit",function(){
            $recommTable.bootstrapTable('refresh');
            return false;
        });
        ...
        $("#toolbar").on("click","button",function(){
            ...
            if(ope=="delete"){
                //获取选中的
                var idArray = $recommTable.bootstrapTable('getAllSelections');
                if(idArray.length==0){
                    alert("至少选择一个");
                    return;
                }
                ...
                $.ajax({
                    type:"post",
                    url:"${pageContext.request.contextPath}/recomms/"+idArray.join(),
                    data:"_method=delete",
