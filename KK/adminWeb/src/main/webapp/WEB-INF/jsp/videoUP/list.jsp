                ...
                <div class="col-xs-12">
                    <div class="box box-success">
                        ...
                        <div class="box-body">
                            ...
                            <div id="toolbar">
                                <a href="${pageContext.request.contextPath}/videos/myVideo/add" class="btn bg-aqua btn-flat">添加</a>
...
<script type="text/javascript">
    $(function(){
        ...
        var queryURL="${pageContext.request.contextPath}/videos/"+userId+"/xx";
        ...
        $("#toolbar").on("click","button",function(){
            ...
            if(ope=="delete"){
                ...
                window.location.href="${pageContext.request.contextPath}/videos/myVideo/"+idArray[0].id+"/edit";
            }
        });
    });
</script>
