...
<script type="text/javascript">
    $(function(){
        ...
        var queryURL="${pageContext.request.contextPath}/collections/"+userId+"/xx";
        $collectionTable = $('#collection_table').bootstrapTable({
            url: queryURL,
            method: 'GET',
        ...
        $('#collection_table').on("click","a[name='child']",function(){
        ...
        $("#toolbar").on("click","button",function(){
            ...
            if(ope=="delete"){
                //获取选中的
                var idArray = $collectionTable.bootstrapTable('getAllSelections');
                idArray = idArray.map(function(item,index){
                    return item.id;
                });
                // delete  /collections/1,2,3,4
                $.ajax({
                    type:"post",
                    url:"${pageContext.request.contextPath}/collections/"+idArray.join(),
                    data:"_method=delete",
                ...
                window.location.href="${pageContext.request.contextPath}/collections/"+idArray[0].id+"/edit";
            }
        });
    });
</script>
