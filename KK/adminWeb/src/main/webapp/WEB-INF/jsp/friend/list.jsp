                ...
                <div class="col-xs-12">
                    <div class="box box-success">
                        ...
                        <div class="box-body">
                            ...
                            <div class="box-body">
                                <div class="row">
                                    <form id="searchForm" action="" onsubmit="return false;" class="form-inline">
                                        <input type="hidden" id="xxId" name="xxId" value="${user.id}">
                            ...
                            <div id="toolbar">
                                <a href="${pageContext.request.contextPath}/friends/${user.id}/add" class="btn bg-maroon btn-flat">添加好友</a>
                                <button type="button" data-ope="delete" class="btn bg-olive btn-flat">删除好友</button>
                            </div>
...
<script type="text/javascript">
    $(function(){
        ...
        var yourId = document.getElementById("xxId").value;
        var queryURL="${pageContext.request.contextPath}/friends/"+yourId+"/xx";
        $friendTable = $('#friend_table').bootstrapTable({
            url: queryURL,
            method: 'GET',
            ...
            columns: [
                {
                    ...
                    formatter : function(value,row,index){
                        return "<a href='${pageContext.request.contextPath}/contents/"+yourId+"/"+row.userId+"/friend'>"+value+"</a>";
                    }
                }
            ],
        ...
        $('#friend_table').on("click","a[name='child']",function(){
        ...
        $("#toolbar").on("click","button",function(){
            ...
            if(ope=="delete"){
                //获取选中的
                var idArray = $friendTable.bootstrapTable('getAllSelections');
                idArray = idArray.map(function(item,index){
                    return item.id;
                });
                // delete  /friends/1,2,3,4
                $.ajax({
                    type:"post",
                    url:"${pageContext.request.contextPath}/friends/"+idArray.join(),
                    data:"_method=delete",
                ...
                window.location.href="${pageContext.request.contextPath}/friends/"+idArray[0].id+"/edit";
            }
        });
    });
</script>
